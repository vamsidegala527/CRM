...
def get_current_user(
    ...
    # Session invalidation check: if token was issued before user.token_revoked_at
    if user.token_revoked_at and iat:
        revoked_timestamp = int(user.token_revoked_at.timestamp())
